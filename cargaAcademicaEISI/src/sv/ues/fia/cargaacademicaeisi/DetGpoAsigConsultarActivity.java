...
public class DetGpoAsigConsultarActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_det_gpo_asig_consultar);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.det_gpo_asig_consultar, menu);
		return true;
	}
